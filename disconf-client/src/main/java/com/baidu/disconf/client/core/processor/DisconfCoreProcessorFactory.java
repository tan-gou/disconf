...
public class DisconfCoreProcessorFactory {
     ...
     * 获取配置文件核心处理器
     */
    public static DisconfCoreProcessor getDisconfCoreProcessorFile(WatchMgr watchMgr,
                                                                   FetcherMgr fetcherMgr, Registry registry) {
     ...
     * 获取配置项核心 处理器
     */
    public static DisconfCoreProcessor getDisconfCoreProcessorItem(WatchMgr watchMgr,
                                                                   FetcherMgr fetcherMgr, Registry registry) {
